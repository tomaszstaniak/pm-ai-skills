...
| 3–4 | Pitch acknowledges a problem but jumps immediately to the solution. Alternatives exist in the conversation only as targets to attack. Value claims are generic ("saves time," "increases productivity"). No proof matched to customer context. |
| 5–6 | Setup exists but is thin — a slide or two on market trends before the demo. Alternatives are mentioned but not fairly characterized. Differentiated value is articulated but not linked to specific capabilities. Proof is present but not customized. |
| 7–8 | Clear Setup and Follow-Through separation. Market insight is specific and credible. Alternatives are described honestly with genuine trade-offs. Differentiated value is tied to unique capabilities. Proof matches customer context. Call to action is clear. |
| 9–10 | Pitch reads as collaborative market education. Buyer confirms understanding at each Setup stage. Differentiation is narrow, specific, and impossible for competitors to claim. Proof is contextually matched. Champion is enabled to advocate internally. Next steps are concrete. |

## The Two-Phase Pitch Structure

The core architecture of every sales conversation is a Setup followed by a Follow-Through. These phases serve fundamentally different purposes and must not be collapsed into each other.

**The Setup** (three components):
1. **Market Insight** — What your experience in this market has taught you about the problem space
2. **Alternatives** — An honest tour of approaches buyers can take, including doing nothing
3. **Perfect World** — What an ideal solution looks like for a buyer in this situation

**The Follow-Through** (five components):
4. **Introduction** — Where your product fits in the landscape you just described
5. **Differentiated Value** — Outcomes only you deliver, compared to alternatives
6. **Proof** — Evidence matched to the buyer's specific context
7. **Objection Handling** — Anticipated concerns addressed proactively
8. **The Ask** — A specific, frictionless next step
...
- [Two-Phase Pitch Structure](references/two-phase-pitch-structure.md) — Detailed breakdown of all eight pitch components with templates, timing guidance, and worked examples for common B2B software scenarios
- [Competitive Alternatives Framing](references/competitive-alternatives-framing.md) — Step-by-step process for mapping and presenting competitive alternatives honestly, including how to handle "do nothing" and prospects with existing vendor preferences
- [Differentiated Value Development](references/differentiated-value-development.md) — Worksheets and worked examples for running the "so what / compared to what" process, identifying weak claims, and building a differentiation statement library
- [Pitch Storyboard Process](references/pitch-storyboard-process.md) — Facilitation guide for cross-functional storyboard sessions, including agenda, decision templates, and testing protocols for new and revised pitches
- [Positioning to Pitch Translation](references/positioning-to-pitch-translation.md) — Framework for connecting the five positioning components from *Obviously Awesome* directly to pitch elements, with audit checklist and alignment diagnostic

## Further Reading

- [Sales Pitch by April Dunford](https://www.amazon.com/dp/B0C3GN64PT?tag=wondelai00-20) — Primary source for this skill
- [Obviously Awesome by April Dunford](https://www.amazon.com/dp/1999023005?tag=wondelai00-20) — Prerequisite reading; establishes the five-component positioning framework that *Sales Pitch* applies to sales conversations
- [The Challenger Sale by Matthew Dixon and Brent Adamson](https://www.amazon.com/dp/1591844355?tag=wondelai00-20) — Complementary approach to teaching customers something new; useful contrast to Dunford's confidence-building model
- [SPIN Selling by Neil Rackham](https://www.amazon.com/dp/0070511136?tag=wondelai00-20) — Questioning framework for the discovery and Setup phases; adds tactical depth to uncovering buyer needs

## About the Author

April Dunford is a positioning consultant and former VP of Marketing who has led go-to-market strategy for over two dozen B2B technology companies. She developed the positioning framework in *Obviously Awesome* from fifteen years of first-hand experience repositioning products at companies ranging from early-stage startups to IBM. *Sales Pitch* extends that positioning work into the sales conversation layer, drawing on her consulting work helping sales teams translate strong positioning into pitches that actually close.
