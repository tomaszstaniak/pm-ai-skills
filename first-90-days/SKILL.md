...
|-----------|-----------|-----------------|------------|
| **S**tart-up | Building something new from scratch | Assemble team, get resources, build from zero | Moving too fast without a plan; burning out |
| **T**urnaround | Saving a business in serious trouble | Make hard calls fast, stop the bleeding | Not acting fast enough; trying to please everyone |
| **A**ccelerated Growth | Managing rapid scaling | Put structure in place without killing what works | Adding too much process; or too little, and things break |
| **R**ealignment | Fixing an organization that doesn't know it's in trouble | Convince people change is needed, then lead it | People don't see the problem; resistance to change |
| **S**ustaining Success | Maintaining a winning organization | Preserve what works, find the next growth curve | Complacency; "if it ain't broke..." thinking; or changing things that shouldn't change |
...
See: [references/stars-model.md](references/stars-model.md)
...
See: [references/early-wins.md](references/early-wins.md)
...
See: [references/five-conversations.md](references/five-conversations.md)
...
- [STARS Model Deep Dive](references/stars-model.md) — Detailed characteristics of each STARS situation, hybrid situations, diagnostic interview questions, and situation-specific playbooks with action timelines
- [Learning Phase Guide](references/learning-phase.md) — Structured learning plan templates, stakeholder interview scripts, cultural assessment framework, and the "5 questions for everyone" technique
- [Early Wins Strategy](references/early-wins.md) — Win identification criteria, coalition building tactics, how to sequence wins for maximum impact, and common early-win traps
- [Acceleration Phase](references/acceleration-phase.md) — Team assessment frameworks, operating rhythm design, resource negotiation strategies, and the 90-day self-assessment template
- [Five Conversations Framework](references/five-conversations.md) — Detailed scripts and preparation guides for each of the 5 boss conversations, timing recommendations, and adaptation for remote/hybrid settings

## Further Reading

- [The First 90 Days by Michael D. Watkins](https://www.amazon.com/First-90-Days-Strategies-Expanded/dp/1422188612?tag=wondelai00-20)
